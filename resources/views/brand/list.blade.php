                        ...
                        <tr  style="font-size: 12px !important;">
                            ...
                            <td>
                                <center>
                                    <a href="/brand/delete/{{ $q->id }}" onclick="return confirm('Hapus Brand {{ $q->nama }}, Lanjutkan?');" class="btn btn-danger btn-xs tooltips" data-popup="tooltip" data-original-title="Delete" data-placement="top"><i class="icon-x"></i></a> &nbsp
