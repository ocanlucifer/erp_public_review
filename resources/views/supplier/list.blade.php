                        ...
                        <tr  style="font-size: 12px !important;">
                            <td class="td-input"><center><a href="/supplier/edit/{{ $q->code }}">{{ $q->code }}</a></center></td>
                            ...
                            <td>
                                <center>
                                    <a href="/supplier/delete/{{ $q->code }}" onclick="return confirm('Hapus Supplier {{ $q->nama }}, Lanjutkan?');" class="btn btn-danger btn-xs tooltips" data-popup="tooltip" data-original-title="Delete" data-placement="top"><i class="icon-x"></i></a>
                                </center>
                            </td>
                        </tr>
                        @endforeach
                        <tr  style="font-size: 12px !important;">
                          <td colspan="15"><center>{{ $result->links() }}</center></td>
                        </tr> 
