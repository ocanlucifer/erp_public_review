                        ...
                        <tr  style="font-size: 12px !important;">
                            <td class="td-input"><center>{{ $q->kode }}</center></td>
                            <td class="td-input"><center>{{ $q->name }}</center></td>
                            <td>
                                <center>
                                    <a href="/countries/delete/{{ $q->id }}" onclick="return confirm('Hapus Country {{ $q->nama }}, Lanjutkan?');" class="btn btn-danger btn-xs tooltips" data-popup="tooltip" data-original-title="Delete" data-placement="top"><i class="icon-x"></i></a> &nbsp
