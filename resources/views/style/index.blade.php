...
<!-- <div class="container"> -->
    <div class=""> 
  	...
  	<ol class="breadcrumb">
      	...
      	<li class="breadcrumb-item active">Master Style</li>
  	</ol>
        ...
        <div class="card">
            ...
            <div class="card-body">
            <div align="right">
              <a href="#" data-toggle="modal" data-target="#modal"class="btn btn-primary"><i class="icon-pencil"></i> Data Style Baru</a>
            </div>
              <br>
...
<div class="row">
  <div id="modal" class="modal fade">
    <div class="modal-dialog">
      <form action="/style/new" method="post" enctype='multipart/form-data'>
        {{ csrf_field() }}
      <div class="modal-content" id="background-body2">
        <div class="modal-header bg-indigo-600">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="modal-title"><strong>Data Style</strong></h6>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <div class="input-group">
              <input type="text" name="name" class="form-control" style="text-transform:uppercase" placeholder="Nama Style" value="" autofocus required>
            </div>
          </div>
          <div class="form-group">
            <div class="input-group">
...
<div class="row">
  <div id="modal_edit" class="modal fade">
    <div class="modal-dialog">
      <form action="/style/update" method="post" enctype='multipart/form-data'>
        {{ csrf_field() }}
      <div class="modal-content" id="background-body2">
        <div class="modal-header bg-indigo-600">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="modal-title"><strong>Edit Data Style</strong></h6>
        </div>
        <div class="modal-body">
          <div id="editform">
