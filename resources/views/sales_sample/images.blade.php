...
<div class="">
        ...
        <div class="col-lg-12">
            <div class="card-body">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/salessamples/materialrequirements/{{$id_sales_sample}}">Material
                            Requirements</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/salessamples/images/{{$id_sales_sample}}">Images</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div align="right">
                <a href="/salessamples/image/new/{{$id_sales_sample}}" data-toggle="modal" data-target="#modal"
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="d-flex justify-content-center d-block mt-3">
                        <img src="{{ url('sales_file/sample/' . $res->source) }}" alt="sample's-image" class=""
                            style="min-height: 30vh; max-height: 30vh; max-width: 40vh;">
                    </div>
                    <div class="d-flex justify-content-center mt-3">
                        <a href="/salessamples/image/edit/{{$res->id}}/{{$res->id_sales_sample}}"
                            class="btn btn-sm btn-info mr-1">Edit</a>
                        <a href="/salessamples/image/delete/{{$res->id}}/{{$res->id_sales_sample}}"
    ...
    <div class="row">
        <div id="modal" class="modal fade">
            <div class="modal-dialog">
                <form action="/salessamples/image/upload/{{$id_sales_sample}}" method="post"
                    enctype='multipart/form-data'>
                    {{ csrf_field() }}
                    <div class="modal-content" id="background-body2">
                        <div class="modal-header bg-indigo-600">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h6 class="modal-title"><strong>Add Sample's Image</strong></h6>
                        </div>
