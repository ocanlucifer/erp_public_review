            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="d-flex justify-content-center d-block mt-3">
                        <img src="{{ url('sales_file/sample/' . $result->source) }}" alt="sample's-image" class=""
                            style="min-height: 30vh; max-height: 30vh; max-width: 40vh;">
                    </div>

                    <form action="/salessamples/image/update/" method="post" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="modal-body">
                            ...
                            <div align="right">
                                <a href="/salessamples/image/{{$id_sales_sample}}" class="btn btn-default"
