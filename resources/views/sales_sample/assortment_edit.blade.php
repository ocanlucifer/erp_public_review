...
<div class="">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/assortment') }}/{{$getsalessample->id}}">Assortment</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="card-body">
                    <form action="/assortment/update" method="post" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="modal-content" id="background-body2">
                            ...
                            <div class="modal-footer">
                                <a href="/assortment/{{$result->id_sales_sample}}" type="button"
