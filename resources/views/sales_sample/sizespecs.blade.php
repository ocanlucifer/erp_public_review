    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="card-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/salessamples/sizespecs/{{$id}}">Size Specs</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <table class="table table-bordered table-striped table-hover table-responsive">
                                    <thead>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>{{$ss->value}}</td>
                                            <td>
                                                <a href="/salessamples/sizespecs/delete/{{ $ss->id }}"
                                                ...
                                                <a href="/salessamples/sizespecs/edit/{{ $ss->id }}"
        ...
        <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="/salessamples/sizespecs/new" method="post" enctype='multipart/form-data'>
                    {{ csrf_field() }}
