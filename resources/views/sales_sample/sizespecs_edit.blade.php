...
<div class="">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/salessamples/sizespecs') }}/{{$getsalessample->id}}">Sizespecs</a>
        </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="card-body">
                    <form action="/salessamples/sizespecs/update" method="post" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="modal-content" id="background-body2">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="id_sales_sample" id="id_sales_sample"
                                                    class="form-control" value="{{$result->id_sales_sample}}" readonly>
                                                <input type="text" name="sample" id="sample" class="form-control"
                                                    value="{{$salessample[0]['number']}}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                            ...
                            <div class="modal-footer">
                                <a href="/salessamples/sizespecs/{{$result->id_sales_sample}}" type="button"
