                        ...
                        <tr  style="font-size: 12px !important;">
                            ...
                            <td>
                                <center>
                                    <a href="/color/delete/{{ $q->id }}" onclick="return confirm('Hapus Color {{ $q->name }}, Lanjutkan?');" class="btn btn-danger btn-xs tooltips" data-popup="tooltip" data-original-title="Delete" data-placement="top"><i class="icon-x"></i></a> &nbsp
