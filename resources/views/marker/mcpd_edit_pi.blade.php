    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                    <form action="{{route('mcp.updatedetail_pi')}}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="modal-content" id="modal-content" style="width: 100%;">
                            ...
                            <input type="hidden" name="pi_id" id="pi_id" value="{{$mcpi->id}}">
                            <input type="hidden" name="pi_mcp" id="pi_mcp" value="{{$mcpi->mcp}}">
                            <input type="hidden" name="pi_id_type" id="pi_id_type" value="{{$mcpi->id_type}}">
                            <input type="hidden" name="pi_mcpwsm_id" id="pi_mcpwsm_id" value="{{$mcpwsm_id}}">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="text" id="pi_untuk"
                                            name="pi_untuk" value="{{$mcpi->untuk}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="number" step="0.01"
                                            name="pi_tot_ws_qty" id="pi_tot_ws_qty" value="{{$mcpwsm->total_qty}}"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" step="0.01" id="pi_ukuran"
                                            name="pi_ukuran" value="{{$mcpi->ukuran}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-4"><input class="form-control form-detail-pi" type="number"
                                            step="0.01" name="pi_lebar_m" id="pi_lebar_m" value="{{$mcpi->lebar_m}}">
                                    </div>
                                    <div class="col-sm-4"><input class="form-control form-detail-pi" type="number"
                                            step="0.01" name="pi_lebar_inc" id="pi_lebar_inc"
                                            value="{{$mcpi->lebar_m * 39.37}}" readonly
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="pi_arah" id="pi_arah">
                                            <option value="" disabled <?php if ($mcpi->arah == "") {
                                                echo selected;} ?>>Select</option>
                                            <option value="diagonal" <?php if ($mcpi->arah == "diagonal") {
                                                echo selected;} ?>>Diagonal</option>
                                            <option value="horizontal" <?php if ($mcpi->arah == "horizontal") {
                                                echo selected;} ?>>Horizontal</option>
                                            <option value="vertikal" <?php if ($mcpi->arah == "vertikal") {
                                ...
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="number" step="0.01"
                                            name="pi_mp_pcs" id="pi_mp_pcs" value="{{$mcpi->mp_pcs}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="number" id="pi_urutan"
                                            name="pi_urutan" value="{{$mcpi->urutan}}" required></div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="text" name="pi_pola_asli"
                                            id="pi_pola_asli" value="{{$mcpi->pola_asli}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="text" name="pi_kode_marker"
                                            id="pi_kode_marker" value="{{$mcpi->kode_marker}}" required>
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    <div class="col-sm-4 text-right"><small><b>Gramasi</b></small></div>
                                    <div class="col-sm-8"><input class="form-control form-detail-pi" type="number"
                                            step="0.01" name="pi_gramasi" id="pi_gramasi" value="{{$mcpi->gramasi}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="date" name="pi_marker_date"
                                            id="pi_marker_date" value="{{$mcpi->marker_date}}" required>
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    <div class="col-sm-4 text-right"><small><b>Skala</b></small></div>
                                    <div class="col-sm-8"><input class="form-control form-detail-pi" type="number"
                                            step="0.01" name="pi_skala" id="pi_skala" value="{{$mcpi->skala}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                ...
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="number" step="0.01"
                                            name="pi_efisiensi" id="pi_efisiensi" value="{{$mcpi->efisiensi}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                ...
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="number" step="0.01"
                                            name="pi_perimeter" id="pi_perimeter" value="{{$mcpi->perimeter}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    <div class="col-sm-4 text-right"><small><b>Kons Sz Tgh</b></small></div>
                                    <div class="col-sm-8"><input class="form-control" type="number" step="0.01"
                                            name="pi_kons_sz_tgh" id="pi_kons_sz_tgh" value="{{$mcpi->kons_sz_tgh}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                ...
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="date" name="pi_tgl_sz_tgh"
                                            id="pi_tgl_sz_tgh" value="{{$mcpi->tgl_sz_tgh}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><input class="form-control" type="number" name="pi_revision"
                                            id="pi_revision" value="{{$mcpi->revision}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><input class="form-control form-detail-pi" type="number"
                                            ...
                                            value="{{$mcpi->tole_lbr_m}}">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    <div class="col-sm-4 text-right"><small><b>Kons (Kg/Dz)</b></small></div>
                                    <div class="col-sm-8"><input class="form-control" type="number" step="0.01"
                                            name="pi_kons_kgdz" id="pi_kons_kgdz" value="{{$mcpi->kons_kgdz}}" readonly
                                            style="background-color: #FFB09F !important;">
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8"><textarea class="form-control" type="text"
                                            ...
                                            id="pi_revision_remark">{{$mcpi->revision_remark}}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-lg-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" name="pdf_marker_name"
                                            id="pdf_marker_name" value="{{$mcpi->pdf_marker}}">
