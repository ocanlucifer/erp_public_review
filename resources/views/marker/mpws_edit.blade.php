        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                    ...
                    <form action="/mp/update_ws/" method="post" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <input type="hidden" name="id" id="id" value="{{$mpwsm->id}}">
                                            <input type="hidden" name="mp" id="mp" value="{{$mpwsm->mp}}">
                                            <div class="input-group">
                                                <label for="no_urut">No Urut</label>
                                                <input id="no_urut" type="number"
                                                    class="form-control @error('no_urut') is-invalid @enderror"
                                                    name="no_urut" value="{{ $mpwsm->no_urut }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="color" type="text"
                                                    ...
                                                    name="color" value="{{ $mpwsm->combo }}" required
                                                    autocomplete="off">
                                                <span>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="ws_qty_tot" type="number" value="0"
                                                    ...
                                                    name="ws_qty_tot" value="{{ $mpwsm->total_qty }}" readonly required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
