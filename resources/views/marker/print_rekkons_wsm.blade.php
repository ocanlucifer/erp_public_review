...
<body>
    ...
    <div class="container page-break">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4">: {{$mcp->order_name}}</div>
        </div>
        <div class="row">
            <div class="col-md-1">Tanggal</div>
            <div class="col-md-4">: {{date("d-m-Y", strtotime($mcp->delivery_date))}}</div>
            <div class="col-md-1">Style </div>
            <div class="col-md-4">: {{$mcp->style}}</div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-12">
                <table>
                    ...
                    <tr>
                        ...
                        <?php $mp[$sby][$sbx] = $a->scale * $d->jml_marker * $d->jml_ampar; ?>
                        <td>{{$a->scale}}</td>
