    ...
    <div class="card">
        ...
        <div class="card-body text-size-small">
            ...
            <div class="mt-3">
                ...
                <a href="#" id="click_create" data-toggle="modal" data-target="#modal" class="btn btn-success btn-sm">Create Worksheet</a>
                <a href="/mcp/confirm/{{$mcp->id}}/1" class="btn btn-warning btn-sm" onclick="return confirm('Anda yakin untuk konfirmasi?')">Confirm</a>
                @else
                <a href="#" id="" class="btn btn-primary btn-sm">Export to Marker Production</a>
                <a href="/mcp/confirm/{{$mcp->id}}/0" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin untuk membatalkan konfirmasi?')">Unconfirm</a>
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="/mcp/edit_ws/{{$mcpwsm->id}}/{{$mcp->id}}">Edit</a>
                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#form" data-wsheet="{{$mcpwsm->id}}" id="click_newtype" onclick="newtype()">New
                                            Type</a>
                                        <hr>
                        ...
                        <div class="modal-body">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="no_urut" type="number" class="form-control @error('no_urut') is-invalid @enderror" name="no_urut" value="{{ old('no_urut') }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <label for="color">Combo</label>
                                            <input id="color" type="text" class="form-control @error('color') is-invalid @enderror" name="color" value="{{ old('color') }}" required autocomplete="off">
                                            <span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input id="ws_qty_tot" type="number" value="0" class="form-control @error('ws_qty_tot') is-invalid @enderror" name="ws_qty_tot" value="{{ old('ws_qty_tot') }}" readonly required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <table class="tabel table-hover table-responsivee" style="width: 100%">
                                        ...
                                        <tbody id="ws_tbody">
                                            <tr>
                                                <td><input class="form-control" type="text" name="input_size[]" id="input_size_1"></td>
                                                <td><input class="form-control" type="number" name="input_ws_qty[]" id="input_ws_qty_1"></td>
                                                <td><input class="form-control" type="number" name="input_tolerance[]" id="input_tolerance_1"></td>
                                                <td><input class="form-control" type="number" name="input_qty_tot[]" id="input_qty_tot_1" readonly>
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tbody>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <button class="btn btn-sm btn-warning" type="button" id="ws_calculate" onclick="calculate()">Calculate</button>
                                    <button class="btn btn-sm btn-success float-right" type="button" id="ws_addrow" onclick="ms_addrow()">Add Row</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content" id="modal-content" style="width: 120%;">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-8"><input class="form-control" type="number" id="no_urut" name="no_urut" required></div>
                        </div>
                        <div class="col-sm-4">
                            <div class="col-sm-4 text-right">Fab Description</div>
                            <div class="col-sm-8"><input class="form-control" type="text" name="fabric_desc" id="fabric_desc">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input id="color_form" type="text" class="form-control @error('color_form') is-invalid @enderror" name="color_form" value="{{ old('color_form') }}" required autocomplete="off">
                                    <span>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    autocomplete="off">
                                    <input id="fabric_construct" type="text" class="form-control @error('fabric_construct') is-invalid @enderror" name="fabric_construct" value="{{ old('fabric_construct') }}" required autocomplete="off">
                                    <span>
                                    ...
                                    @enderror --}}
                                    <input type="hidden" id="id_fabricconst" type="text" class="form-control @error('id_fabricconst') is-invalid @enderror" name="id_fabricconst" value="{{ old('id_fabricconst') }}" required autocomplete="off">
                                    <input id="fabricconst" type="text" class="form-control @error('fabricconst') is-invalid @enderror" name="fabricconst" value="{{ old('fabricconst') }}" required autocomplete="off">
                                    <span>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-8"><textarea class="form-control" name="remark" id="remark" cols="20" rows="2"></textarea></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    @enderror --}}
                                    <input type="hidden" id="id_fabriccomp" type="text" class="form-control @error('id_fabriccomp') is-invalid @enderror" name="id_fabriccomp" value="{{ old('id_fabriccomp') }}" required autocomplete="off">
                                    <input id="fabriccomp" type="text" class="form-control @error('fabriccomp') is-invalid @enderror" name="fabriccomp" value="{{ old('fabriccomp') }}" required autocomplete="off">
                                    <span>
                ...
                <div class="modal-content" id="modal-content" style="width: 120%;">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-8"><input class="form-control" type="number" id="urutan" name="urutan" required></div>
                        </div>
                        <div class="col-sm-4">
                            <div class="col-sm-4 text-right"><small><b>*Code</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="text" name="code" id="code" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="col-sm-4 text-right"><small><b>Marker Date</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="date" name="marker_date" id="marker_date">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Efisiensi (%)</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="efisiensi" id="efisiensi">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Perimeter</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="perimeter" id="perimeter">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                        ...
                        <div class="col-sm-4 mt-lg-1">
                            ...
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="tole_pjg_m" id="tole_pjg_m">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Tole Lbr (m)</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="tole_lbr_m" id="tole_lbr_m">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Kons Sz Tgh</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="kons_sz_tgh" id="kons_sz_tgh">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Tgl Sz Tgh</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="date" name="tgl_sz_tgh" id="tgl_sz_tgh">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Panjang (m)</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="panjang_m" id="panjang_m">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Lebar (m)</b></small></div>
                            <div class="col-sm-4"><input class="form-control" type="number" step="0.01" name="lebar_m" id="lebar_m">
                            </div>
                            <div class="col-sm-4"><input class="form-control" type="number" step="0.01" name="lebar_inc" id="lebar_inc" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Gramasi</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="gramasi" id="gramasi">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Total Skala</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="total_skala" id="total_skala">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Kons Kain Yd/Dz</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="kons_yddz" d id="kons_yddz" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Kons Kain Kg/Dz</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="kons_kgdz" d id="kons_kgdz" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Kons Kain m/Dz</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="kons_mdz" id="kons_mdz" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Jumlah Marker</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="jml_marker" id="jml_marker">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Jumlah Ampar</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="number" step="0.01" name="jml_ampar" id="jml_ampar">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>PDF Marker</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="file" name="pdf_marker" id="pdf_marker">
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Qty (yard)</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="text" step="0.01" name="qty_yard" id="qty_yard" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Qty (kg)</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="text" step="0.01" name="qty_kg" id="qty_kg" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Qty (m)</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="text" step="0.01" name="qty_m" id="qty_m" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Ujiung Kain Yd</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="text" step="0.01" name="ujungkain_yd" id="ujungkain_yd" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Ujiung Kain Kg</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="text" step="0.01" name="ujungkain_kg" id="ujungkain_kg" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                            <div class="col-sm-4 text-right"><small><b>Ujiung Kain Mtr</b></small></div>
                            <div class="col-sm-8"><input class="form-control" type="text" step="0.01" name="ujungkain_m" id="ujungkain_m" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-lg-1">
                        ...
                        <div class="col-sm-4 mt-lg-1">
                            ...
                            <div class="col-sm-8"><textarea class="form-control" type="text" name="revisi_remark" id="revisi_remark"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 mt-lg-1">
                            <div class="row">
                                <div class="col-sm-4">
                                    <input type="submit" id="submit_detail" name="submit_detail" class="btn btn-primary ml-10">
                                    <div class="col-sm-4">
                                    </div>
                                    <button type="button" data-dismiss="modal" class="btn btn-primary">Batal</button>
                                    <button class="btn btn-sm btn-warning" type="button" id="ws_calculate" onclick="calculate_d()">Calculate</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <table class="table table-condensed">
                                    ...
                                    <tbody id="table-detail">
                                        <tr>
                                            <td><input type="text" class="form-control" name="detail_size" id="detail_size" readonly>
                                            </td>
                                            ...
                                            <td><input type="text" class="form-control" name="detail_scales" id="detail_scales"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
