<input type="hidden" name="id_collar_cuff" id="id_collar_cuff" value="{{$collarcuffitem->id}}">
<input type="hidden" name="id_cons_sup" id="id_cons_sup" value="{{$collarcuffitem->id_cons_sup}}">
<div class="row">
    <div class="col-sm-4">
        <div class="col-sm-4 text-right"><small><b>*Unit</b></small></div>
        <div class="col-sm-8">
            <input type="text" class="form-control" onkeyup="keyUp_unit()" name="unit" id="unit" autocomplete="off" required value="{{$collarcuffitem->unit}}">
            <div id="unitlist"></div>
        </div>
    </div>
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control kg_per_pcs" type="number" step="0.01"
                name="qty_unit" id="qty_unit" onkeyup="calc();" required value="{{$collarcuffitem->qty_unit}}">
        </div>
    </div>
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control" type="number" step="0.01"
                name="budget_price" id="budget_price" required value="{{$collarcuffitem->budget_price}}"
                onkeyup="calc();">
        </div>
    </div>
    <div class="col-sm-4">
        ...
        <div class="col-sm-8">
            <input type="hidden" id="id_color" name="id_color" required value="{{$collarcuffitem->id_color}}">
            <input type="text" class="form-control" name="color" id="color" onkeyup="keyUpColor()" autocomplete="off" required value="{{$collarcuffitem->fab_color['name']}}">
    ...
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control total_quantity_pcs" type="number" step="0.01"
                ...
                style="background-color: #FFB09F !important;" required value="{{$collarcuffitem->total_qty_unit_pcs}}">
        </div>
    </div>
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control supplier_price" type="number" step="0.01"
                name="supplier_price" id="supplier_price" required  value="{{$collarcuffitem->supplier_price}}"
                onkeyup="calc();">
        </div>
    </div>
    <div class="col-sm-4">
        ...
        <div class="col-sm-8"><input class="form-control form-detail-ma" type="number" step="0.01"
                name="total_qty" id="total_qty" onkeyup="calc();" required value="{{$collarcuffitem->total_qty}}">
        </div>
    </div>
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control total_quantity_kg" type="number" step="0.01"
                ...
                style="background-color: #FFB09F !important;" required value="{{$collarcuffitem->total_qty_unit}}">
        </div>
    </div>
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control amount" type="number" step="0.01"
                name="amount" id="amount" required  value="{{$collarcuffitem->amount}}"
    ...
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control tolerance" type="number" step="0.01"
                name="tole" id="tole" onkeyup="calc();" required value="{{$collarcuffitem->tole}}">
        </div>
    </div>
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control freight_cost" type="number" step="0.01"
                name="freight" id="freight" onkeyup="calc();" value="{{$collarcuffitem->freight}}">
        </div>
    </div>
    <div class="col-sm-4 mt-lg-1">
        ...
        <div class="col-sm-8"><input class="form-control amount_with_freight" type="number" step="0.01"
                name="amount_freight" id="amount_freight" value="{{$collarcuffitem->amount_freight}}"
                style="background-color: #FFB09F !important;" onkeyup="calc();">
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <table class="table-bordered table-hover  table-responsive">
        ...
        <tbody id="add-size-range-tbody">
            <?php $count = 0;?>
            @foreach ($itemsizerange as $isr)
            <?php $count++; ?>
                <tr>
                    <td>
                        <input type="text" name="dimension[]" id="dimension_{{$count}}" value="{{$isr->dimension}}">
                    </td>
                    <td>
                        <input type="hidden" id="id_size_{{$count}}" name="id_size[]" value="{{$isr->id_size}}">
                        <input type="text" name="sizeitem[]" id="sizeitem_{{$count}}" onkeyup="keyUpSize({{$count}})" autocomplete="off" value="{{$isr->itemSize['name']}}">
                        <div id="sizeitemlist_{{$count}}"></div>
                    </td>
                    <td>
                        <input style="width:100px !important;" type="number" step="0.001" name="total[]" id="total_{{$count}}" class="sr-total" onkeyup="calc();" required value="{{$isr->total}}">
                    </td>
                    <td bgcolor="green">
                        <input style="width:100px !important;" type="number" step="0.001" name="total_tole[]" id="total_tole_{{$count}}" class="sr-total-tol" onkeyup="calc();" required value="{{$isr->total_tole}}">
                    </td>
                    <td bgcolor="green">
                        <input style="width:100px !important;" type="number" step="0.001" name="total_rounded[]" id="total_rounded_{{$count}}" class="sr-total-round" onkeyup="calc();" required value="{{$isr->total_rounded}}">
                    </td>
                    <td>
                        <center>
                            <a href="#" onclick="$(this).parent().parent().parent().remove();calc();">(X)</a>
                        </center>
                    </td>
                </tr>
            @endforeach
...
<script type="text/javascript">
    ...
    function collarcuff_addrow(){
        ...
        bariscollarcuff = '<tr>'+
            ...
            '<td>'+'<input style="width:100px !important;" type="number" step="0.001" name="total[]" id="total_'+count+'" class="sr-total" onkeyup="calc();" required>'+'</td>'+
