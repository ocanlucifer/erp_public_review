...
<div class="">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/salessorders') }}">Master Sales Order</a></li>
    ...
    <?php $id_sales_order = Requests::segment(5); ?>
        ...
        <div class="col-lg-12">
            <div class="card-body">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/salesorders/image/{{$id_sales_order}}">Image</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                    ...
                    <form action="/salesorders/materialrequirements/update/{{$id_sales_order}}" method="post"
                        ...
                        <div class="modal-content" id="background-body2">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                    <a href="{{url('/salesorders/materialrequirements/' . $id_sales_order)}}"
