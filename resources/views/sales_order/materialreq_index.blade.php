...
<div class="">
        ...
        <div class="col-lg-12">
            <div class="card-body">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/salesorders/materialrequirements/{{$id_sales_order}}">Material
                            Requirements</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/salesorders/image/{{$id_sales_order}}">Images</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="#" data-toggle="modal" data-target="#modal"
                        class="btn btn-primary @if ($warning) <?php echo "disabled";?> @endif"><i
                            class="icon-pencil"></i>
            ...
            <table class="table table-bordered table-responsive text-center">
                ...
                <tbody id="tbody_main">
                    @include('sales_order.materialreq_list')
                </tbody>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div id="modal" class="modal fade">
            <div class="modal-dialog">
                <form action="/salesorders/materialrequirements/new/{{$id_sales_order}}" method="post"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <table class="table text-center">
                    ...
                    <input type="hidden" name="id_sales_order2" id="id_sales_order2" value="">
    ...
    <script type="text/javascript">
        ...
        function getDatas(page){
            ...
            $.ajax({
                url : '{{URL::to("/salesorders/materialrequirements/idorder")}}?page=' + page,
                type : 'get',
                dataType: 'json',
        ...
        function submit(perintah) {
            if (perintah == "tambah") {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{URL::to("/salesorders/materialrequirements/getData")}}',
                    data: {id : perintah, _token: _token},
                    dataType: 'json',
                    success: function(data) {
                        $('[name="id2"]').val(data.id);
                        $('[name="id_sales_order2"]').val(data.id_sales_order);
        ...
        function tambahData()
        {
            var id_sales_order = $("[name= 'id_sales_order2']").val();
            ...
            $.ajax({
                type: 'POST',
                url: '{{URL::to("/salesorders/materialrequirements/tambah_detail")}}',
                data: { _token: _token,
            ...
            $.ajax({
                type:"GET",
                url:"{{ route('so_materialrequirements.get_detail') }}",
        ...
        function ubahDataDetail()
        {
            ...
            $.ajax({
                type: 'POST',
                url: '{{URL::to("/salesorders/materialrequirements/update_detail")}}',
                data: { _token: _token,
                        id:id,
                        id_sales_order:id_sales_order,
                        id_material_req:id_material_req,
        ...
        function hapusData(id, id_matreq) {
            ...
            if (tanya) {
                ...
                $.ajax({
                    type: "POST",
                    url: '{{URL::to("/salesorders/materialrequirements/hapus_detail")}}',
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(document).on("click","#row_detail", function(){
                ...
                let id_sales_order = $(this).data("idsales");

                $('#set_number_detail').html('Number : ' + number_mat);
                document.getElementById("id_sales_order2").value = id_sales_order;
